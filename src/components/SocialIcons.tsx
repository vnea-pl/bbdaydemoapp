...
export const SocialIcons = () => {
  return (
    <div className="text-center space-y-4 w-full">
      <p className="text-sm font-normal opacity-90">Or continue with:</p>
      
      <div className="flex justify-between items-center w-full">
        <div className="w-14 h-14 bg-white rounded-xl flex items-center justify-center">
          <svg width="28" height="28" viewBox="0 0 268.1522 273.8827" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
            <defs>
              <linearGradient id="a">
        ...
        <div className="w-14 h-14 bg-white rounded-xl flex items-center justify-center">
          <svg width="23" height="28" viewBox="0 0 814 1000" xmlns="http://www.w3.org/2000/svg" xmlSpace="preserve">
            <path d="M788.1 340.9c-5.8 4.5-108.2 62.2-108.2 190.5 0 148.4 130.3 200.9 134.2 202.2-.6 3.2-20.7 71.9-68.7 141.9-42.8 61.6-87.5 123.1-155.5 123.1s-85.5-39.5-164-39.5c-76.5 0-103.7 40.8-165.9 40.8s-105.6-57-155.5-127C46.7 790.7 0 663 0 541.8c0-194.4 126.4-297.5 250.8-297.5 66.1 0 121.2 43.4 162.7 43.4 39.5 0 101.1-46 176.3-46 28.5 0 130.9 2.6 198.3 99.2zm-234-181.5c31.1-36.9 53.1-88.1 53.1-139.3 0-7.1-.6-14.3-1.9-20.1-50.6 1.9-110.8 33.7-147.1 75.8-28.5 32.4-55.1 83.6-55.1 135.5 0 7.8 1.3 15.6 1.9 18.1 3.2.6 8.4 1.3 13.6 1.3 45.4 0 102.5-30.4 135.5-71.3z"/>
          </svg>
        </div>
        <div className="w-14 h-14 bg-white rounded-xl flex items-center justify-center">
          <svg width="14" height="28" viewBox="0 0 30 64" xmlns="http://www.w3.org/2000/svg" fill="none">
            <path d="M27.84 35.998L29.3577 24.416H19.871V16.9C19.871 13.732 21.1958 10.642 25.4449 10.642H29.7571V0.782C29.7571 0.782 25.8444 0 22.1023 0C14.2904 0 9.18427 5.548 9.18427 15.59V24.418H0.5V36H9.18427V64H19.871V36L27.84 35.998Z" fill="#3B5998"/>
          </svg>
        </div>
      </div>
    </div>
